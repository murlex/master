...
//console.log("ex9-c -----------------------------");
//console.log(ex9.gospitalization[2].patient3.patientGospitalization.length);
console.log("ex9-d -----------------------------");
console.log(ex9.gospitalization[2].patient3.patientGospitalization[0].firstGosp.nameDrug);
console.log(ex9.gospitalization[2].patient3.patientGospitalization[1].secondGosp.nameDrug);
console.log(ex9.gospitalization[2].patient3.patientGospitalization[2].thirdGosp.nameDrug);
console.log("ex9-d var 2 -----------------------------");
var gosp=ex9.gospitalization[2].patient3.patientGospitalization;
console.log(gosp[0].firstGosp.nameDrug);
console.log(gosp[1].secondGosp.nameDrug);
console.log(gosp[2].thirdGosp.nameDrug);